...
.alert-primary { background-color: #ff6f61; color: #fff; }
.alert-info { background-color: #ffa69e; color: #fff; }
.alert-danger { background-color: #ff8b94; color: #fff; }
.alert-success { background-color: #ffaaa5; color: #fff; }
</style>
<main>
  <?php if (isset($_POST['search_but'])) {
    ...
    <div class="container-md mt-2">
      <h1 class="display-4 text-center">FLIGHTS FROM: <br> <?php echo $dep_city; ?> to <?php echo $arr_city; ?></h1>
